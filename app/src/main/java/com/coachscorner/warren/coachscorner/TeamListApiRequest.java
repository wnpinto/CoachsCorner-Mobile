...
public class TeamListApiRequest extends CoachsCornerApiRequest{
    private String url = "getTeamList/";
    TextView mTextView;
    ...
    public TeamListApiRequest( TextView mTextView)
    {
        ...
        return new JsonObjectRequest
                (Request.Method.GET, getUrl(), null, new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        setResponseMessage("Failed to retrieve Team List Data.");
